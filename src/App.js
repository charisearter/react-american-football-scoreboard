...
function App() {
  ...
  const [homeScore, setHomeScore] = useState(0);// [variable for score, utility name to store for the score] initially set to 0
  //useState sets score to 0
  //awayScore stores current score set by useState
  //set*Score is function that will say what to do
  //set*Score(*score + 7 (TD) or 3 (FG)) to update score accordingly
  //onClick = {e => set*Score(*score + 7 or 3)} put directly on button
